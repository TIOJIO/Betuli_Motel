...
const AddData = ({values,handleMouseDownPassword,handleClickShowPassword,handleChange,addFormData,onImageChange,editFormData ,handleEditFormChange ,handleCancelClik,handleEditFormSubmit}) => {
  return (
     ...
     <div className='container'>
      ...
      <div className='bloc'>
        ...
        <div style={{marginTop:'30px'}}>
               ...
               <img style={{width:'100px'}} src={editFormData.profile} />
               </Box>
