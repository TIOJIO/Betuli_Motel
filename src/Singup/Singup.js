...
<button 
   style={{backgroundColor:"green",fontFamily: "Times New Roman, Times, serif",color:"white",border:'none',borderRadius:'5px',height:"40px",width:"110px",float:"left"}}>
    INSCRIPTION
    </button>
//gestin erreur
      ...
      >
        <CircularProgress color="inherit" />
                        ...
                        <form onSubmit={handleSubmit}  >
                           <h2 style={{color:"green",textAlign:"center"}}> INSCRIPTION</h2>
                             ...
                             <Link to="./Login"><h3 style={{color:"green"}}> Déja inscrit ? Connecté-vous.</h3></Link>
                         </form>
                        </Grid>
                     </Grid>
              </Container>
