...
import './style.css';
 ...
 const App =()=>{
  ...
  const exportPDF = () => {
    ...
    const data = contacts.map(contact=> [contact.matiere, contact.jour, contact.maxstudent, contact.heuredebut, contact.heurefin]);
   ...
   // edit data
    ...
    const handleEditClick=(event , contact) => {
        ...
        const formValues = { 
          matiere:contact.matiere,
          jour:contact.jour,
         maxstudent:contact.maxstudent,
         heuredebut:contact.heuredebut,
    ...
    const handleEditFormSubmit = (event) => {
        ...
        const editContact = {
            ...
            jour:editFormData.jour,
           heuredebut:editFormData.heuredebut,
...
// submit new data
   ...
   const handleAddFormSubmit = (event) => {
    ...
    const newContact={
        ...
        jour:addFormData.jour,
       heuredebut:addFormData.heuredebut,
       ...
       <Box sx={{ width: '100%' }}>      
         <Paper sx={{ width: '100%', mb: 2 }}>
           ...
           <Table   aria-labelledby="tableTitle" size={dense ? 'small' : 'medium'} > 
                ...
                .map((contact, index) => {
                  const isItemSelected = isSelected(contact.matiere);
                      ...
                      return(
                        <Fragment>
                             { editContactId === contact.id ? (
                              ...
                              <TableRow
                              hover
                              onClick={(event) => handleClick(event, contact.matiere)}
                              role="checkbox"
                            ...
                            >
                              ...
                              >
                                ...
                                <p  style={{fontWeight:"bold",padding:'13px 0px 0px 15px'}}>{contact.matiere}</p>
                              </TableCell>
                              <TableCell  align="right" style={{width:'auto'}}>
                                    <p style={{fontWeight:"bold",color:'green',padding:'0px 0px 0px -10px'}}>{contact.jour}</p> 
                              </TableCell>
                              <TableCell align="right" style={{width:'250px',color:'green',padding:'0px 0px 0px 150px'}}>{contact.heuredebut}</TableCell>
                              <TableCell style={{width:'200px',padding:'0px 0px 0px 100px'}}>{contact.heurefin}</TableCell>
