...
export default function CustomizedMenus({handleDoubleClik,contact,handleDeleteClik,handleEditClick,handleEditFormChange,handleCancelClik,handleEditFormSubmit}) {
