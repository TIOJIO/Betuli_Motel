...
class CreateSchool extends Component {
  ...
  render(){
     return(
         <div>
         <br></br>
         <Typography style={{color:'green',fontWeight:'bold',fontSize:'20px'}}>CREATE A NEW SCHOOL</Typography> <br/>

         <div style={{  width: '100%',borderRadius:'20px',backgroundColor:'white'}}>
            <div style={{backgroundColor:'green', borderRadius:'10px 10px 0px 0px',}}>
   ...
   <div style={{display:'flex',justifyContent:'space-evenly',width:'auto',backgroundColor:'white'}}>
          ...
          <div style={{width:'100px',textAlign:"center",padding:"30px 0px 0px 0px"}}>
            ...
            <div style={{width:'450px',padding:'30px 0px 7px 0px',lineHeight:'80px'}}>
              ...
              <div style={{width:'450px',padding:'30px 0px 7px 0px',lineHeight:'80px'}}>    
                ...
                <Button               
                 style={{ backgroundColor:'green',width:'100px',color:'white',padding:"10px 20px 10px 20px"}}
        ...
        <p> <Link to="/loginUser" style={{fontFamily: "Times New Roman, Times, serif",fontSize:"15px",color:"green",float:"right"}}> <b>Se connecte en tant que Utilisateurs?</b></Link></p><br></br>
         <p><Link to="./loginAdmin" style={{fontFamily: "Times New Roman, Times, serif",fontSize:"15px",color:"green",float:"right"}}> <b>Se connecte en tant que administrateur?</b></Link></p>
