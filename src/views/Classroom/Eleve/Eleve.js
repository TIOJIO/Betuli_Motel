...
// submit new data
   ...
   const handleCancelClik = () => {
      ...
      setEdit(false);
      setView(true);
      history.push('classroom/NavigationBar/#aff');
   }
                        ...
                        <Fragment>
                            ...
                            >
                              ...
                              <TableCell style={{width:'100px',padding:'15px 0px 0px 80px'}}>
                                 <p style={{height:'30px',padding:'5px 0px 0px 0px',textAlign:"center",width:'55px',borderRadius:'20px',backgroundColor:'green',color:'white'}}>  </p>
                              </TableCell>
